...
if(CMAKE_COMPILER_IS_GNUCXX OR CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  ...
  # -Wpsabi is GCC-only (warns about ABI changes); Clang does not support it.
  if(CMAKE_COMPILER_IS_GNUCXX)
    set(WPSABI_FLAG "-Wpsabi")
  endif()
  # Clang warns about unused private fields and set-but-unused variables in
  # code that compiles cleanly under GCC; suppress until the codebase is cleaned up.
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    set(CLANG_EXTRA_FLAGS "-Wno-unused-private-field -Wno-unused-but-set-variable")
  endif()
  set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -DNOMINMAX -D_FORTIFY_SOURCE=2 -Wall -Wextra -Werror -Wfatal-errors ${WPSABI_FLAG} ${CLANG_EXTRA_FLAGS} -Og -ggdb ${ASAN_SANITIZERS} ${PROFILING_FLAGS}")
  set(CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_EXE_LINKER_FLAGS_DEBUG} ${ASAN_SANITIZERS} ${PROFILING_FLAGS}")
  set(CMAKE_CXX_FLAGS_RELEASE
      "${CMAKE_CXX_FLAGS_RELEASE} -DNOMINMAX -D_FORTIFY_SOURCE=2 -Wall -Wextra -Werror -Wfatal-errors ${WPSABI_FLAG} ${CLANG_EXTRA_FLAGS} -O3 -fomit-frame-pointer ${PROFILING_FLAGS}")
